...
## Compatible with the Zybo Z7-20 and Zybo Z7-10
...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { clk_out }]; #IO_0_35 Sch=led[2]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports{ seq_in }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
